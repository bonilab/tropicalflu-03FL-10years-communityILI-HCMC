...
save(profile_llk_bp1,file = 'Rdata/profile_lk_bp1_2-stepfunc_cyc365_iliplus.Rdata')
...
save(profile_llk_bp2,file = 'Rdata/profile_lk_bp2_2-stepfunc_cyc365_iliplus.Rdata')
profile_llk_bp2
...
save(profile_llk_val1,file = 'Rdata/profile_lk_val1_2-stepfunc_cyc365_iliplus.Rdata')
profile_llk_val1
...
save(profile_llk_val2,file = 'Rdata/profile_lk_val2_2-stepfunc_cyc365_iliplus.Rdata')
profile_llk_val2
