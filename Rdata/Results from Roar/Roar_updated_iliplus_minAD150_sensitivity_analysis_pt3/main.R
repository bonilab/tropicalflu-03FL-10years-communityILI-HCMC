...
# The cycles in pt3 is 350 - 450
all_cycle = seq(350,450,5)
all_N = seq(4,8,1)
iters = 120
...
for (row_index in 99:nrow(node_args)) {
    ...
    ret[[row_index]] %<-% {
        ...
        for (i in 1:iters) {
            all_fits[[i]] %<-% fit_multi_stepfunc(data = ili_plus_21d_df$ili_plus_smth_7d,
